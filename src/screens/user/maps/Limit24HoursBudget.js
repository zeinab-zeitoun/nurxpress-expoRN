...
import { StyleSheet, Text, View, Dimensions, StatusBar, ActivityIndicator, Button, Platform } from 'react-native';
...
export default function Limit24HourseBudget(props) {
  ...
  const getNurses = async () => {
    await apiNurse.limitNurses24HoursBudget(props.route.params.budget24,token)
    .then(res => {
        setNurses(res.data)})
    .catch( err => console.log(err))
}
  ...
  useEffect( () => {
    console.log(props.route.params.budget24)
      getToken()
