...
import { StyleSheet, Text, View, Dimensions, TouchableOpacity, ActivityIndicator, Button, Platform, statusBarHeight } from 'react-native';
...
export default function Limit8HourseBudget(props) {
  ...
  const getNurses = async () => {
      await apiNurse.limitNurses8HoursBudget(props.route.params.budget8,token)
      .then(res => {
          setNurses(res.data)})
      .catch( err => console.log(err))
  }
  ...
  useEffect( () => {
    console.log(props.route.params.budget8)
      getToken()
